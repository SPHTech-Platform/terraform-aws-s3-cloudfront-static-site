...
| <a name="input_cloudfront_logging_config"></a> [_cloudfront\_logging\_config](#input\_cloudfront\_logging\_config) | Map containing cloudfront access logging configuration. | `map(string)` | `{}` | no |
